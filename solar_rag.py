...
from langchain.chains import create_history_aware_retriever # 예전 대화내용 활용
from langchain_core.prompts import ChatPromptTemplate, MessagesPlaceholder # MessagesPlaceholder 답변 잠시 보관

from langchain.chains import create_retrieval_chain # retriever가 쓰는 체인
from langchain.chains.combine_documents import create_stuff_documents_chain # 문서관리 체인
